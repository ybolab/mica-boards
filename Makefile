# mica-virt-arm64: the virt-arm64 board (UEFI on QEMU virt). The BSP build lives under bsp/,
...
help:
	...
	@echo "  pool                every producer -- the board packages and mica-kernel-virt-arm64 -- indexed into _out/debs"
